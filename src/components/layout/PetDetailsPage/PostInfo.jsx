...
export default function PostInfo({
    ...
    // Math configuration for display details on likes row
        ...
        <div className={styles.postViewWrapper}>
            ...
            <div className={styles.postHeaderIdentity}>
                ...
                <div className={styles.identityMetaText}>
                    ...
                    <span>@{username || "anonymous"} • Verified Creator</span>
                </div>
                <button 
                    type="button" 
            ...
            <div className={styles.tagContainer}>
                <span className={styles.postTag}>#Creative</span>
                <span className={styles.postTag}>#Showcase</span>
            </div>
            ...
            {likedUsers.length > 0 && (
                <div className={styles.likedUsersSection}>
                    ...
                    <span className={styles.likedUsersText}>
                        {likedUsers.length >= 2 ? (
                            <>Liked by <strong>{firstLikerName}</strong>, <strong>{secondLikerName}</strong> and <strong>{anonymousOthersCount > 0 ? `${anonymousOthersCount.toLocaleString()} others` : "others"}</strong></>
                        ) : (
            ...
            <div className={styles.socialActionsBar}>
                ...
                <button type="button" className={styles.actionBtn} onClick={handleShare}>
                    ...
                    <span>{shareCopied ? "Link Copied!" : `Share (${shares || 0})`}</span>
                </button>
            </div>
