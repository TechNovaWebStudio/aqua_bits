...
import PostFeed from "@/components/layout/postView/PostFeed";
...
export default function VideoDetails({ params }) {
  // Unwrap params using React.use() to ensure compatibility with Next.js App Router rules
    ...
    <>
      ...
      <div className="app-grid-wrapper">
        ...
        <main className="main-section">
          ...
          {/* Pass the target post id to the feed component */}
          <PostFeed targetId={id} />
        </main>
